...
CREATE TABLE IF NOT EXISTS t_prueba (
	id INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS t_ws_history (
	id INT(11) NOT NULL AUTO_INCREMENT,
	...
	responseFormat VARCHAR(255) NULL DEFAULT NULL,
	serviceName VARCHAR(70) NULL DEFAULT '',
	numberOfElements INT(11) NULL DEFAULT '0',
	PRIMARY KEY (id),
	CONSTRAINT fk_ws_history_t_user FOREIGN KEY (userId) REFERENCES t_group (id) ON DELETE NO ACTION ON UPDATE NO ACTION,
);
